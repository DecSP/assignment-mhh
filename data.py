...
data["U_Blow"], data["U_Ext_CO2"], data["U_Pad"], data["U_Roof"], data["U_Side"], data["U_ThScr"],  data["U_Vent_Forced"] = 0.1, 0.1, 0.5, 0.1, 0.9, 0.5, 0.1
...
data["LAI"] = 2.0
data["CO2_Out"] = 668
data["eta_Side"], data["eta_Roof"], data["eta_Pad"], data["eta_HeatVap"] = 1, 0.5, 0, 4.43 * 10 ** -8
